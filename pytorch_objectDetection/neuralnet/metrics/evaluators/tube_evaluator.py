...
import numpy as np
from neuralnet.metrics.evaluators.pascal_voc_evaluator import (
    calculate_ap_11_point_interp,
    calculate_ap_every_point,
)
from neuralnet.metrics.tube import Tube
from neuralnet.metrics.utils.enumerators import MethodAveragePrecision
from neuralnet.metrics.utils.read_files import File
...
class TubeEvaluator:
    ...
    def __init__(
        ...
        Args:
            ...
            method (MethodAveragePrecision, optional): Recall interpolation method (see neuralnet.metrics.utils.enumerators). Defaults to MethodAveragePrecision.EVERY_POINT_INTERPOLATION.
        """
